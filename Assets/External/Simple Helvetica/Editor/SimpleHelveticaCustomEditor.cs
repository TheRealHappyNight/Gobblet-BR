...
public class SimpleHelveticaCustomEditor : Editor {
    ...
    static void SimpleHelvetica()
    {
		...
		GameObject tmp = Resources.Load<GameObject>("Assets/External/Simple Helvetica/Models/_Alphabets.fbx");
		newAlphabets = Instantiate(tmp);
		...
		thisMeshRenderer.sharedMaterial = Resources.Load("Assets/External/Simple Helvetica/Materials/Default.mat", typeof(Material)) as Material;
